<?php
if ( ! class_exists( 'News_Port_Posts_Tile_Widget' ) ) {
	/**
	 * Adds News_Port_Posts_Tile_Widget Widget.
	 */
	class News_Port_Posts_Tile_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_port_tile_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-section style-1',
				'description' => __( 'Retrive Posts Tile Widgets', 'news-port' ),
			);
			parent::__construct(
				'news_port_posts_tile_widget',
				__( 'Ascendoor Posts Tile Widget', 'news-port' ),
				$news_port_tile_widget_ops
			);
		}
