<?php
if ( ! class_exists( 'News_Port_Posts_Tile_And_List_Widget' ) ) {
	/**
	 * Adds News_Port_Posts_Tile_And_List_Widget Widget.
	 */
	class News_Port_Posts_Tile_And_List_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_port_posts_tile_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-list-section style-1',
				'description' => __( 'Retrive Posts Tile And List Widgets', 'news-port' ),
			);
			parent::__construct(
				'news_port_posts_tile_and_list_widget',
				__( 'Ascendoor Posts Tile And List Widget', 'news-port' ),
				$news_port_posts_tile_list_widget_ops
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			if ( ! empty( $tile_list_title || $tile_list_button_label ) ) {
				?>
							...
							<div class="mag-post-single has-image <?php echo esc_attr( $i == 1 ? 'tile-design' : 'list-design' ); ?>">
								...
								<div class="mag-post-detail">
									<div class="mag-post-category <?php echo esc_attr( 1 === $i ? 'with-background' : '' ); ?>">
										...
										news_port_categories_list( $with_background );
										?>
									</div>
