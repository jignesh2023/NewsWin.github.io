<?php
if ( ! class_exists( 'News_Port_Posts_Grid_Widget' ) ) {
	/**
	 * Adds News_Port_Posts_Grid_Widget Widget.
	 */
	class News_Port_Posts_Grid_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_port_grid_posts_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-section style-1',
				'description' => __( 'Retrive Posts Grid Widgets', 'news-port' ),
			);
			parent::__construct(
				'news_port_posts_grid_widget',
				__( 'Ascendoor Posts Grid Widget', 'news-port' ),
				$news_port_grid_posts_widget_ops
			);
		}
