<?php
if ( ! class_exists( 'News_Port_Posts_Carousel_Widget' ) ) {
	/**
	 * Adds News_Port_Posts_Carousel_Widget Widget.
	 */
	class News_Port_Posts_Carousel_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$news_port_posts_carousel_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-post-carousel-section',
				'description' => __( 'Retrive Posts Carousel Widgets', 'news-port' ),
			);
			parent::__construct(
				'news_port_posts_carousel_widget',
				__( 'Ascendoor Posts Carousel Widget', 'news-port' ),
				$news_port_posts_carousel_widget_ops
			);
		}
